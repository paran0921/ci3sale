            ...
            <form action="" name="form1" method="post">
                <table class="table table-bordered table-sm mymargin5">
                    ...
                    <tr>
                        ...
                        <td width="80%" align="left">
                        <div class="form-inline"><?php echo $row->numi; ?></div>
                        </td>
                    </tr>
                    <tr>
                ...
                <div align="center">
                    <a href="/jangbui/edit/<?php echo $tmp; ?>" class="btn btn-sm mycolor1">수정</a>&nbsp;
                    <a href="/jangbui/del/<?php echo $tmp; ?>" class="btn btn-sm mycolor1" onclick="return confirm('삭제할까요?');">삭제</a>&nbsp;
