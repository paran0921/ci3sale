                ...
                <table class="table table-bordered table-sm mymargin5">
                    <tr>
                        ...
                        <div class="input-group input-group-sm date" id="writeday">
                            <input type="text" name="writeday" value="<?php echo set_value("writeday"); ?>" class="form-control form-control-sm">
                    ...
                    <tr>
                        ...
                        <td width="80%" align="left">
                            <div class="form-inline">
                                <input type="hidden" name="product_no" value="<?php echo set_value("product_no"); ?>">
                                <input type="text" name="product_name" id="product_name" value="" class="form-control form-control-sm" disabled>
                    ...
                    <tr>
                        ...
                        <td width="80%" align="left">
                        <div class="form-inline">
                            <input type="text" name="prices" value="" class="form-control form-control-sm" readonly style="boder:0">
                        </div>
                        </td>
                    </tr>
                    <tr>
