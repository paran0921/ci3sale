            ...
            <script>
                function find_text() {
                    form1.action="/jangbui/lists/text1/" + form1.text1.value;
                    form1.submit();
                }
            ...
            <form action="" name="form1" method="post">
                <div class="row">
                    ...
                    <div class="col-9" align="right">
                        <a class="btn btn-sm mycolor1" href="/jangbui/add<?php echo $tmp; ?>">추가</a>
                    </div>
                </div>
            </form>
...
?>
                    <tr>
                        ...
                        <td align="left"><a href="/jangbui/view/no/<?php echo $no ?><?php echo $tmp; ?>"><?php echo $row->product_name ?></a></td>
                        <td align="right"><?php echo number_format($row->price); ?></td>
                        <td align="right"><?php echo number_format($row->numi); ?></td>
